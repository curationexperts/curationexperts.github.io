...
{var pred__11518 = cljs.core._EQ_;var expr__11519 = limit;if(cljs.core.truth_(pred__11518.call(null,1,expr__11519)))
...
var G__11521 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11522 = (limit__$1 - 1);
var G__11523 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11521;
limit__$1 = G__11522;
parts = G__11523;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11525 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11525))
{var replacement_11526 = temp__4090__auto___11525;buffer.append([cljs.core.str(replacement_11526)].join(''));
} else
{buffer.append(ch);
}
{
var G__11527 = (index + 1);
index = G__11527;
continue;
}
}
